...
static void test_apx_nodeData_updatePortData(CuTest* tc)
{
   ...
   apx_parser_t *parser = apx_parser_new();
   apx_nodeData_t *destNodeData = apx_nodeData_makeFromString(parser, dest_node_text_dest);
   apx_nodeData_t *srcNodeData = apx_nodeData_makeFromString(parser, src_node_text);
