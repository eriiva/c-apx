...
typedef void (apx_nodeData_inDataWriteFunc)(uint32_t offset, uint32_t len);
...
typedef struct apx_nodeData_tag
{
   ...
   apx_nodeData_inDataWriteFunc *apxNodeWriteCbk; //This is used to trigger callbacks in static ApxNode files generated by Python
